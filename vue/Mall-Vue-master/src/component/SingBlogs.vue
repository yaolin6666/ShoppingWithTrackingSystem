  ...
  <div class="ss">
    <div class="qw">
      ...
      <div :data="admin" style="width: 100%" class="sss">
        <div class="k">
          <p style="font-size:20px;font-weight:bold;font-weight:bold;word-wrap:break-word;word-break:break-all;width:600px;">
            {{ admin.productName }}5555555555555555555555555555555555555555555555555555555555555555555555</p>
          ...
          <div class="ef">
            <div class="wq"><p><img src="@/assets/ww.png" width="600px" height="38px"></p>
              <div style="margin-top: 10px;margin-bottom:10px">
                ...
                <span
                    style="font-size:31px;font-weight:bold;color: rgb(238, 82, 25);">{{ admin.productPrice * admin.productNum }}.00</span>
              </div>
            </div>
            <div class="vc">
      ...
      <span style="font-weight:bold;">3.51</span>
       <span>元</span>
          ...
          <div class="vx">
            <span style="color: rgb(155, 154, 154);margin-left:17px;">货源号</span>

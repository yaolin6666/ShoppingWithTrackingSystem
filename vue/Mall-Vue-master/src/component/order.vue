    ...
    <div class="tt1">
      ...
      >
        ...
        <div class="vv">
          ...
          菜鸟驿站代收服务
          <button style="background: rgb(238, 94, 94);border: none;width:30px;margin-top: 2px;color: seashell;">免费
          </button>
        </div>
      </div>
    </div>
      ...
      <el-popover
        ...
        >
          ...
          <el-form-item
            ...
            prop="shippingMoney"
          >
            <el-input v-model="notice.shippingMoney">{{notice.productNum * notice.productPrice +
              notice.shippingMoney}}
            </el-input>
          </el-form-item>

<template>
    <div style="padding: 10px;">
        ...
        <el-dialog title="" v-model="dialogVisible" width="800">
            <el-card>
                <el-form
                        ref="fruitRules"
                        :model="admins"
                    ...
                    <el-row>
                        ...
                        <el-col :span="7">
                            <el-form-item
                                    ...
                                    prop="oneCategoryId"
                            >
                                <el-select v-model="admins.oneCategoryId" placeholder="请选择商品分类">
                                    <el-option
                        ...
                        <el-col :span="6">
                            <el-form-item
                                    ...
                                    prop="twoCategoryId"
                            >
                                <el-select v-model="admins.twoCategoryId" placeholder="请选择商品分类">
                                    <el-option
                    ...
                    <el-row>
                        <el-col :span="8">
                            <el-form-item
                                    ...
                                    prop="brandId"
                            >
                                <el-select v-model="admins.brandId" placeholder="请选择品牌">
                                    <el-option
                        ...
                        <el-col :span="7">
                            ...
                            >
                                <el-select v-model="admins.threeCategoryId" placeholder="请选择商品类型品牌">
                                    <el-option
                        ...
                        <el-col :span="6">
                            <el-form-item
                                    ...
                                    prop="productNum"
                            >
                                <el-input v-model="admins.productNum"></el-input>
                            </el-form-item>
                        </el-col>
